 ...
 * 求职招聘
 */
public class QiuZhiZhaoPingDetailActivity1 extends BaseActivity {
    ...
    protected void initView() {
        ...
        LinearLayoutManager llm1 = new LinearLayoutManager(QiuZhiZhaoPingDetailActivity1.this);
    ...
    protected void initData() {
        model = (Fragment3Model.ListBean) getIntent().getSerializableExtra("QiuZhiZhaoPingDetail");
        Glide.with(this)
