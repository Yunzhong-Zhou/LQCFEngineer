 ...
 * 技术交流
 */
public class JiShuJiaoLiuActivity extends BaseActivity {
    int page = 0;
    String keys = "", y_circle_id = "0";

    TextView tv_quanbu, tv_zuixin, tv_addr;
    private RecyclerView recyclerView;
    //    List<JishuJiaoLiuModel.ListBean> list = new ArrayList<>();
//    CommonAdapter<JishuJiaoLiuModel.ListBean> mAdapter;
    ...
    protected void initView() {
        ...
        springView.setListener(new SpringView.OnFreshListener() {
            ...
            public void onRefresh() {
                ...
                params.put("i_classify", "7");//1为招聘 2为案例 3为店铺出租 4为二手配件 5为工具租赁 6为机友求助 7为技术交流 8为活动
            ...
            public void onResponse(Fragment3Model response) {
                ...
                if (list.size() > 0) {
                    ...
                    mAdapter = new CommonAdapter<Fragment3Model.ListBean>
                            (JiShuJiaoLiuActivity.this, R.layout.item_jishujiaoliu, list) {
                        @Override
                        protected void convert(ViewHolder holder, Fragment3Model.ListBean model, int position) {
                            ...
                            Glide.with(JiShuJiaoLiuActivity.this)
...
//                                        .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                            ...
                            if (model.getExchange_info().getImgArr() != null && model.getExchange_info().getImgArr().size() > 0) {
                                ...
                                LinearLayoutManager llm1 = new LinearLayoutManager(JiShuJiaoLiuActivity.this);
                                ...
                                CommonAdapter<String> mAdapter_tupian = new CommonAdapter<String>
                                        (JiShuJiaoLiuActivity.this, R.layout.item_img_110_110, images) {
                                    @Override
                                ...
                                mAdapter_tupian.setOnItemClickListener(new OnItemClickListener() {
                                    ...
                                    public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int i) {
                                        ...
                                        PhotoShowDialog photoShowDialog = new PhotoShowDialog(JiShuJiaoLiuActivity.this, images, i);
                    ...
                    mAdapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
                        ...
                        public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int i) {
                            ...
                            CommonUtil.gotoActivityWithData(JiShuJiaoLiuActivity.this, JiShuJiaoLiuDetailActivity.class, bundle, false);
                        }
    ...
    protected void updateView() {
        titleView.setTitle("技术交流");
        titleView.showRightTextview("发布", R.color.blue, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CommonUtil.gotoActivity(JiShuJiaoLiuActivity.this, AddJiShuJiaoLiuActivity.class, false);
            }
        });
    }
}
