 ...
 * 已付款
 */
public class YiFuKuanActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yifukuan);
        mImmersionBar.reset()
            ...
            public void onResponse(CouponModel response) {
                ...
                if (list_youhuiquan.size() > 0) {
                    ...
                    mAdapter_youhuiquan = new CommonAdapter<CouponModel.ListBean>
                            (YiFuKuanActivity.this, R.layout.item_coupon, list_youhuiquan) {
                        @Override
...
//                        titleView.setTitle("已提车");
                ...
                mAdapter_service = new CommonAdapter<OrderDetailModel.OrderInfoBean.OrderServiceListBean>(
                        YiFuKuanActivity.this, R.layout.item_service, model.getOrder_info().getOrder_service_list()) {
                    @Override
...
//                holder.setText(R.id.serviceallmoney, "¥" + bean.get);
                        ...
                        LinearLayoutManager llm1 = new LinearLayoutManager(YiFuKuanActivity.this);
                        ...
                        CommonAdapter<OrderDetailModel.OrderInfoBean.OrderServiceListBean.OrderGoodsListBeanX> ca_s =
                                new CommonAdapter<OrderDetailModel.OrderInfoBean.OrderServiceListBean.OrderGoodsListBeanX>
                                        (YiFuKuanActivity.this, R.layout.item_orderdetail_goods, bean.getOrder_goods_list()) {
                                    @Override
                                    protected void convert(ViewHolder holder, OrderDetailModel.OrderInfoBean.OrderServiceListBean.OrderGoodsListBeanX model1, int p) {
                                        ...
                                        Glide.with(YiFuKuanActivity.this).load(URLs.IMGHOST + model1.getGoods_info().getGImg())
                                                .centerCrop()
...
//                                        String[] strArr = model1.getGoods_info().getImgStr().split("\\|\\|");
                                        ...
                                        CommonAdapter<String> ca = new CommonAdapter<String>
                                                (YiFuKuanActivity.this, R.layout.item_img_80_80, list_img) {
                                            @Override
                                            protected void convert(ViewHolder holder, String model, int position) {
                                                ImageView iv = holder.getView(R.id.iv);
                                                Glide.with(YiFuKuanActivity.this).load(model)
                                                        .centerCrop()
//                            .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                                                        .placeholder(R.mipmap.loading)//加载站位图
                                                        .error(R.mipmap.zanwutupian)//加载失败
                                        ...
                                        ca.setOnItemClickListener(new OnItemClickListener() {
                                            ...
                                            public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int i) {
                                                PhotoShowDialog photoShowDialog = new PhotoShowDialog(YiFuKuanActivity.this, list_img, i);
                            ...
                            case 2:
                                ...
                                addgoods.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        CommonUtil.gotoActivityWithData(YiFuKuanActivity.this, SelectGoodsActivity.class, bundle2, false);
                                    }
                                });
                                break;
                            case 3:
                ...
                mAdapter_other = new CommonAdapter<OrderDetailModel.OrderInfoBean.OrderGoodsListBean>
                        (YiFuKuanActivity.this, R.layout.item_orderdetail_goods, model.getOrder_info().getOrder_goods_list()) {
                    @Override
...
//                            .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                ...
                mAdapter_jiance = new CommonAdapter<OrderDetailModel.TestingDetailsListBean>(
                        YiFuKuanActivity.this, R.layout.item_orderdetail_jiance, model.getTesting_details_list()) {
                    @Override
...
//                            .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                        ...
                        tv_chageproject.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                CommonUtil.gotoActivityWithData(YiFuKuanActivity.this, AddProjectActivity.class, bundle, false);
                            }
                        });
                        //删除商品
                        if (model.getOrder_info().getGState() >= 4) {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ll_feiyong:
                ...
                CommonUtil.gotoActivityWithData(YiFuKuanActivity.this, CouponActivity.class, bundle4, false);
                break;
            case R.id.iv_message:
                ...
                CommonUtil.gotoActivityWithData(YiFuKuanActivity.this, WebContentActivity.class, bundle, false);
                break;
            case R.id.iv_call:
                //拨打电话
...
//                               intent.setAction(Intent.ACTION_DIAL);//只调用拨号界面，不拨出电话
            ...
            case R.id.tv_addservice:
                ...
                CommonUtil.gotoActivityWithData(YiFuKuanActivity.this, AddServiceActivity.class, bundle1, false);
                break;
            ...
            case R.id.tv_addproject:
                ...
                CommonUtil.gotoActivityWithData(YiFuKuanActivity.this, AddProjectActivity.class, bundle3, false);
                break;
...
//                        break;
            ...
            case R.id.tv_fukuan:
                ...
                BaseDialog dialog1 = new BaseDialog(YiFuKuanActivity.this);
                ...
                rv.setLayoutManager(new LinearLayoutManager(YiFuKuanActivity.this));

                CommonAdapter<String> adapter = new CommonAdapter<String>
                        (YiFuKuanActivity.this, R.layout.item_dialog_list, arrayList) {
                    @Override
                    protected void convert(ViewHolder holder, String model, int position) {
...
//                        dialog1.dismiss();
            ...
            case R.id.tv_fanhui:
                //返回
                showToast("确认返回待施工吗？", "确认", "取消", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        dialog.dismiss();
                        Map<String, String> params = new HashMap<>();
...
//                    finish();
                    if (isNext) {
                        ...
                        CommonUtil.gotoActivityWithData(YiFuKuanActivity.this, YiTiCheActivity.class, bundle, true);
                    } else {
//                        finish();
                        Bundle bundle = new Bundle();
                        bundle.putString("y_techn_sedan_id", y_techn_sedan_id);
                        CommonUtil.gotoActivityWithData(YiFuKuanActivity.this, DaiShiGongActivity.class, bundle, true);
                    }
                }
    ...
    protected void updateView() {
       ...
       /* titleView.setRightBtn(R.mipmap.ic_scan_black, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CaptureActivity.launch(YiFuKuanActivity.this, config);
            }
        });*/
    }
