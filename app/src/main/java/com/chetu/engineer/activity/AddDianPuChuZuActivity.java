 ...
 * 发布店铺出租
 */
public class AddDianPuChuZuActivity extends BaseActivity {
    EditText editText1, editText2, editText3, editText4, editText5, editText6;
    String v_title = "", contacts = "", contact_infor = "", v_cost = "", v_address = "", v_text = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adddianpuchuzu);
        mImmersionBar.reset()
...
//                myToast("上传图片成功");
                ...
                params.put("contact_infor", contact_infor);
                params.put("v_cost", v_cost);
    ...
    private void RequestUpData(Map<String, String> params) {
        OkhttpUtil.okHttpPost(URLs.AddDianPuChuZu, params, headerMap, new CallBackUtil() {
            @Override
    ...
    private boolean match() {
        ...
        contacts = editText2.getText().toString().trim();
        ...
        contact_infor = editText4.getText().toString().trim();
        if (TextUtils.isEmpty(contact_infor)) {
            myToast("请输入联系方式");
            return false;
        }
        v_cost = editText5.getText().toString().trim();
        if (TextUtils.isEmpty(v_cost)) {
            myToast("请输入费用");
            return false;
        }
        v_address = editText6.getText().toString().trim();
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            // 进入相册
            PictureSelector.create(AddDianPuChuZuActivity.this)
