 ...
 * 待复检
 */
public class DaiFuJianActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daifujian);
        mImmersionBar.reset()
...
//                showEmptyPage();
            ...
            public void onResponse(OrderDetailModel response) {
                ...
                tv_yujitime.setText(model.getTechn_sedan_info().getEstimateTime());//预计完成时间

                /**
                 * 服务列表
                 */
                mAdapter_service = new CommonAdapter<OrderDetailModel.OrderInfoBean.OrderServiceListBean>(
                        DaiFuJianActivity.this, R.layout.item_service_fujian, model.getOrder_info().getOrder_service_list()) {
                    @Override
                    protected void convert(ViewHolder holder, OrderDetailModel.OrderInfoBean.OrderServiceListBean bean, int position) {
                        ...
                        holder.setText(R.id.tv_jianchatime, "检查时间：" + bean.getCheckTime());//检查时间
                        if (bean.getCheckTime() != null && !bean.getCheckTime().trim().equals("")) {
                            holder.setText(R.id.tv_jianchatype, "已检查");//检查状态
                        } else {
                            holder.setText(R.id.tv_jianchatype, "未检查");//检查状态
                        }

                        //商品列表
                        RecyclerView rv_s = holder.getView(R.id.rv_s);
                        LinearLayoutManager llm1 = new LinearLayoutManager(DaiFuJianActivity.this);
                        ...
                        CommonAdapter<OrderDetailModel.OrderInfoBean.OrderServiceListBean.OrderGoodsListBeanX> ca_s =
                                new CommonAdapter<OrderDetailModel.OrderInfoBean.OrderServiceListBean.OrderGoodsListBeanX>
                                        (DaiFuJianActivity.this, R.layout.item_orderdetail_goods, bean.getOrder_goods_list()) {
                                    @Override
                                    protected void convert(ViewHolder holder, OrderDetailModel.OrderInfoBean.OrderServiceListBean.OrderGoodsListBeanX model1, int p) {
                                        ...
                                        Glide.with(DaiFuJianActivity.this).load(URLs.IMGHOST + model1.getGoods_info().getGImg())
                                                .centerCrop()
...
//                                        num = model1.getGNum();
                                        ...
                                        //                        holder.setText(R.id.tv_wangongtime, bean.get);//完工时间
//                        holder.setText(R.id.tv_wangongtype, bean.get);//完工状态
//                        holder.setText(R.id.tv_jianchatime, bean.get);//检查时间
//                        holder.setText(R.id.tv_jianchatype, bean.get);//检查状态
...
//                                        String[] strArr = model1.getGoods_info().getImgStr().split("\\|\\|");
                                        ...
                                        CommonAdapter<String> ca = new CommonAdapter<String>
                                                (DaiFuJianActivity.this, R.layout.item_img_80_80, list_img) {
                                            @Override
                                            protected void convert(ViewHolder holder, String model, int position) {
                                                ImageView iv = holder.getView(R.id.iv);
                                                Glide.with(DaiFuJianActivity.this).load(model)
                                                        .centerCrop()
//                            .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                                                        .placeholder(R.mipmap.loading)//加载站位图
                                                        .error(R.mipmap.zanwutupian)//加载失败
                                        ...
                                        ca.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
                                            ...
                                            public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int i) {
                                                PhotoShowDialog photoShowDialog = new PhotoShowDialog(DaiFuJianActivity.this, list_img, i);
                        ...
                        TextView fangong = holder.getView(R.id.fangong);
                                    ...
                                    public void onClick(View v) {
                                        showToast("确认施工完成了吗？", "确认", "取消", new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                RequestChangeServiceType(params, 2);
                                            }
                                        }, new View.OnClickListener() {
                                            @Override
                                            public void onClick(View v) {
                                    ...
                                    public void onClick(View v) {
                                        showToast("确认复检完成了吗？", "确认", "取消", new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                RequestChangeServiceType(params, 3);
                                            }
                                        }, new View.OnClickListener() {
                                            @Override
                                            public void onClick(View v) {
                                    ...
                                    public void onClick(View v) {
                                        showToast("确认开始施工吗？", "确认", "取消", new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                RequestChangeServiceType(params, 1);
                                            }
                                        }, new View.OnClickListener() {
                                            @Override
                                            public void onClick(View v) {
                        ...
                        fangong.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                showToast("确认返工吗？", "确认", "取消", new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        dialog.dismiss();
                                        Map<String, String> params = new HashMap<>();
                                        params.put("u_token", localUserInfo.getToken());
                                        params.put("y_order_service_id", bean.getYOrderServiceId());
                                        params.put("g_state", "0");//1为进行施工中 2为已完成  3已检查
                                        RequestChangeServiceType(params, 0);
                                    }
                                }, new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
...
//                                    list_img.add(URLs.IMGHOST + s);
                        ...
                        LinearLayoutManager llm_img = new LinearLayoutManager(DaiFuJianActivity.this);
...
//                            .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                ...
                mAdapter_other = new CommonAdapter<OrderDetailModel.OrderInfoBean.OrderGoodsListBean>
                        (DaiFuJianActivity.this, R.layout.item_orderdetail_goods, model.getOrder_info().getOrder_goods_list()) {
                    @Override
...
//                            .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                ...
                mAdapter_jiance = new CommonAdapter<OrderDetailModel.TestingDetailsListBean>(
                        DaiFuJianActivity.this, R.layout.item_orderdetail_jiance, model.getTesting_details_list()) {
                    @Override
...
//                            .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                        ...
                        tv_chageproject.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                CommonUtil.gotoActivityWithData(DaiFuJianActivity.this, AddProjectActivity.class, bundle, false);
                            }
                        });
                        //删除商品
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ll_feiyong:
                ...
                CommonUtil.gotoActivityWithData(DaiFuJianActivity.this, CouponActivity.class, bundle4, false);
                break;
            case R.id.iv_message:
                ...
                CommonUtil.gotoActivityWithData(DaiFuJianActivity.this, WebContentActivity.class, bundle, false);
                break;
            case R.id.iv_call:
                //拨打电话
...
//                               intent.setAction(Intent.ACTION_DIAL);//只调用拨号界面，不拨出电话
            ...
            case R.id.tv_addservice:
                ...
                CommonUtil.gotoActivityWithData(DaiFuJianActivity.this, AddServiceActivity.class, bundle1, false);
                break;
            case R.id.tv_addgoods:
                ...
                CommonUtil.gotoActivityWithData(DaiFuJianActivity.this, SelectGoodsActivity.class, bundle2, false);
                break;
            case R.id.tv_addproject:
                //添加检测项目
                Bundle bundle3 = new Bundle();
                bundle3.putString("y_techn_sedan_id", y_techn_sedan_id);
                CommonUtil.gotoActivityWithData(DaiFuJianActivity.this, AddProjectActivity.class, bundle3, false);
                break;
...
//                        break;
                ...
                if (i > 0) {
                    showToast("您还有" + i + "个项目未复检");
                } else {
                    showToast("确认检查完毕了吗？", "确认", "取消", new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            dialog.dismiss();
                            Map<String, String> params = new HashMap<>();
                            ...
                            params.put("y_techn_sedan_id", y_techn_sedan_id);
                            params.put("g_state", (model.getOrder_info().getGState() + 1) + "");//2为待施工 3为进行中 4待复检  5为待完工 6为已提车  7为付款
                            RequestChageType(params, (model.getOrder_info().getGState() + 1), true);
                        }
                    }, new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
            ...
            case R.id.tv_fukuan:
                ...
                showToast("确认返回上一步吗？", "确认", "取消", new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        params.put("u_token", localUserInfo.getToken());
                        params.put("y_techn_sedan_id", y_techn_sedan_id);
                        params.put("g_state", "3");//2为待施工 3为进行中 4待复检  5为待完工 6为已提车  7为付款
                        RequestChageType(params, 3, false);
                    }
                }, new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
...
//                    finish();
                    if (isNext) {
                        ...
                        CommonUtil.gotoActivityWithData(DaiFuJianActivity.this, YiWanGongActivity.class, bundle, true);
                    } else {
//                        finish();
                        Bundle bundle = new Bundle();
                        bundle.putString("y_techn_sedan_id", y_techn_sedan_id);
                        CommonUtil.gotoActivityWithData(DaiFuJianActivity.this, JinXingZhongActivity.class, bundle, true);
                    }
                }
     ...
     * @param params
     */
    private void RequestChangeServiceType(Map<String, String> params, int type) {
    ...
    protected void updateView() {
        ...
        titleView.setRightBtn(R.mipmap.ic_scan_black, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CaptureActivity.launch(DaiFuJianActivity.this, config);
            }
        });
    }
