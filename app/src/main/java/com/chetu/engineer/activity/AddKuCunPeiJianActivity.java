 ...
 * 发布库存配件
 */
public class AddKuCunPeiJianActivity extends BaseActivity {
    EditText editText1, editText3, editText4;
    String v_title = "", v_price = "", v_bring = "", v_text = "";
    TextView editText2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addkucunpeijian);
        mImmersionBar.reset()
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.editText2:
                //入职时间
                setDate1("请选择购入时间", editText2, editText2.getText().toString().trim());
                break;
...
//                myToast("上传图片成功");
    ...
    private void RequestUpData(Map<String, String> params) {
        OkhttpUtil.okHttpPost(URLs.AddKuCunPeiJian, params, headerMap, new CallBackUtil() {
            @Override
    ...
    private boolean match() {
        ...
        v_bring = editText2.getText().toString().trim();
        if (TextUtils.isEmpty(v_bring)) {
            myToast("请选择购入时间");
            return false;
        }
        ...
        v_price = editText4.getText().toString().trim();
...
//        calendar.add(Calendar.YEAR, 100);
        ...
        pvTime1 = new TimePickerBuilder(AddKuCunPeiJianActivity.this, new OnTimeSelectListener() {
            @Override
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            // 进入相册
            PictureSelector.create(AddKuCunPeiJianActivity.this)
