 ...
 * 发布工具租赁
 */
public class AddGongJuZuLinActivity extends BaseActivity {
    EditText editText1, editText2, editText3,editText4,editText5;
    String v_title = "", v_price = "", v_specifi = "",v_duration="",v_text="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addgongjuzulin);
        mImmersionBar.reset()
...
//                myToast("上传图片成功");
                ...
                params.put("v_specifi", v_specifi);
                params.put("v_duration", v_duration);
    ...
    private void RequestUpData(Map<String, String> params) {
        OkhttpUtil.okHttpPost(URLs.AddGongJuZuLin, params, headerMap, new CallBackUtil() {
            @Override
    ...
    private boolean match() {
        ...
        v_price = editText2.getText().toString().trim();
        ...
        v_specifi = editText4.getText().toString().trim();
        if (TextUtils.isEmpty(v_specifi)) {
            myToast("请输入规格");
            return false;
        }
        v_duration = editText5.getText().toString().trim();
        if (TextUtils.isEmpty(v_duration)) {
            myToast("请输入租赁时长");
            return false;
        }
        return true;
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            // 进入相册
            PictureSelector.create(AddGongJuZuLinActivity.this)
