 ...
 * 发布维修案例
 */
public class AddWeiXiuAnLiActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addweixiuanli);
        mImmersionBar.reset()
...
//                myToast("上传图片成功");
    ...
    private void RequestUpData(Map<String, String> params) {
        OkhttpUtil.okHttpPost(URLs.AddWeiXiuAnLi, params, headerMap, new CallBackUtil() {
            @Override
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            // 进入相册
            PictureSelector.create(AddWeiXiuAnLiActivity.this)
