 ...
 */
public class KuCunPeiJianDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kucunpeijiandetail);
    }
    ...
    protected void initView() {
        ...
        LinearLayoutManager llm1 = new LinearLayoutManager(KuCunPeiJianDetailActivity.this);
    ...
    protected void initData() {
        model = (Fragment3Model.ListBean) getIntent().getSerializableExtra("KuCunPeiJianDetail");
        Glide.with(this)
...
//                                        .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
        ...
        tv_title.setText("标题：" + model.getParts_info().getV_title());
        tv_type.setText("购入时间：" + model.getParts_info().getV_bring());
        tv_addr.setText("价格：" + model.getParts_info().getV_price());
        tv_starttime.setText("正文：" + model.getParts_info().getV_text());
//        tv_endtime.setText("门店地址：" + model.getLease_info().getV_address());
//        tv_content.setText("正文：" + model.getLease_info().getV_text());
        ...
        if (model.getParts_info().getImgArr() != null && model.getParts_info().getImgArr().size() > 0) {
            ...
            CommonAdapter<String> mAdapter_tupian = new CommonAdapter<String>
                    (KuCunPeiJianDetailActivity.this, R.layout.item_img_110_110, images) {
                @Override
                protected void convert(ViewHolder holder, String model, int position) {
                    ImageView iv = holder.getView(R.id.iv);
                    Glide.with(KuCunPeiJianDetailActivity.this)
                            .load(model)
                            .centerCrop()
                            .placeholder(R.mipmap.loading)//加载站位图
                            .error(R.mipmap.zanwutupian)//加载失败
            ...
            mAdapter_tupian.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
                ...
                public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int i) {
                    ...
                    PhotoShowDialog photoShowDialog = new PhotoShowDialog(KuCunPeiJianDetailActivity.this, images, i);
