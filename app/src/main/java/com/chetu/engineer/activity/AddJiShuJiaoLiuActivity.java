 ...
 * 发布技术交流
 */
public class AddJiShuJiaoLiuActivity extends BaseActivity {
    EditText editText1, editText2, editText3;
    String y_circle_id = "0", v_title = "", v_text = "", v_describe = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addjishujiaoliu);
        mImmersionBar.reset()
...
//                myToast("上传图片成功");
                ...
                params.put("y_circle_id", y_circle_id);//圈子id 如果存在 就只能在圈子显示
                params.put("v_title", v_title);
                params.put("v_text", v_text);
                params.put("v_describe", v_describe);
    ...
    private void RequestUpData(Map<String, String> params) {
        OkhttpUtil.okHttpPost(URLs.AddJiShuJiaoLiu, params, headerMap, new CallBackUtil() {
            @Override
    ...
    private boolean match() {
        ...
        v_describe = editText2.getText().toString().trim();
        if (TextUtils.isEmpty(v_describe)) {
            myToast("请输入描述");
            return false;
        }
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            // 进入相册
            PictureSelector.create(AddJiShuJiaoLiuActivity.this)
