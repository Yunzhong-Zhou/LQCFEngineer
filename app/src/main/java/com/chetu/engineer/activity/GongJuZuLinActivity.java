 ...
 * 工具租赁
 */
public class GongJuZuLinActivity extends BaseActivity {
    int page = 0;
    ...
    protected void initView() {
        ...
        springView.setListener(new SpringView.OnFreshListener() {
            ...
            public void onRefresh() {
                ...
                params.put("i_classify", "5");//1为招聘 2为案例 3为店铺出租 4为二手配件 5为工具租赁 6为机友求助 7为技术交流 8为活动
            ...
            public void onResponse(Fragment3Model response) {
                ...
                if (list.size() > 0) {
                    ...
                    mAdapter = new CommonAdapter<Fragment3Model.ListBean>
                            (GongJuZuLinActivity.this, R.layout.item_gongjuzulin, list) {
                        @Override
...
//                            holder.setText(R.id.tv_addr, model.getUser_info().getUserName());
                            ...
                            Glide.with(GongJuZuLinActivity.this)
...
//                                        .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                    ...
                    mAdapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
                        ...
                        public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int i) {
                            ...
                            CommonUtil.gotoActivityWithData(GongJuZuLinActivity.this, GongJuZhuLinDetailActivity.class, bundle, false);
                        }
    ...
    protected void updateView() {
        ...
        titleView.showRightTextview("发布", R.color.blue, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CommonUtil.gotoActivity(GongJuZuLinActivity.this, AddGongJuZuLinActivity.class, false);
            }
        });
    }
}
