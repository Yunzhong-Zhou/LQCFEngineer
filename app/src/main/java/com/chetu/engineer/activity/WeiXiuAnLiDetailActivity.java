 ...
 */
public class WeiXiuAnLiDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weixiuanlidetail);
    }
    ...
    protected void initView() {
        ...
        LinearLayoutManager llm1 = new LinearLayoutManager(WeiXiuAnLiDetailActivity.this);
    ...
    protected void initData() {
        model = (Fragment3Model.ListBean) getIntent().getSerializableExtra("WeiXiuAnLiDetail");
        Glide.with(this)
...
//                                        .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
        ...
        tv_title.setText("标题：" + model.getCase_info().getV_title());
        tv_type.setText("正文：" + model.getCase_info().getV_text());
//        tv_addr.setText("地址：" + model.getActivity_info().getV_place());
//        tv_starttime.setText("开始时间：" + model.getActivity_info().getV_start_time());
//        tv_endtime.setText("结束时间：" + model.getActivity_info().getV_end_time());
//        tv_content.setText("活动内容：" + model.getActivity_info().getV_content());

        if (model.getCase_info().getImgArr() != null && model.getCase_info().getImgArr().size() > 0) {
            rv_tupian.setVisibility(View.VISIBLE);
            ArrayList<String> images = new ArrayList<>();
            for (String s : model.getCase_info().getImgArr()) {
                images.add(URLs.IMGHOST + s);
            }
            CommonAdapter<String> mAdapter_tupian = new CommonAdapter<String>
                    (WeiXiuAnLiDetailActivity.this, R.layout.item_img_110_110, images) {
                @Override
                protected void convert(ViewHolder holder, String model, int position) {
                    ImageView iv = holder.getView(R.id.iv);
                    Glide.with(WeiXiuAnLiDetailActivity.this)
                            .load(model)
                            .centerCrop()
                            .placeholder(R.mipmap.loading)//加载站位图
                            .error(R.mipmap.zanwutupian)//加载失败
            ...
            mAdapter_tupian.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
                ...
                public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int i) {
                    ...
                    PhotoShowDialog photoShowDialog = new PhotoShowDialog(WeiXiuAnLiDetailActivity.this, images, i);
