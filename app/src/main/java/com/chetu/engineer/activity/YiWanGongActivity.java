 ...
 * 已完工
 */
public class YiWanGongActivity extends BaseActivity {
    ...
    TextView tv_carnum, tv_name, tv_time, tv_carname, tv_carpailiang, tv_carnianfen, tv_carlicheng,
            tv_money, tv_beizhu, tv_jiechename,tv_songcheaddr,tv_id;
    TextView tv_allmoney, tv_confirm, tv_fukuan, tv_addservice, tv_addgoods, tv_addproject,tv_fanhui;
    ...
    List<CouponModel.ListBean> list_youhuiquan = new ArrayList<>();
    CommonAdapter<CouponModel.ListBean> mAdapter_youhuiquan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yiwangong);
        mImmersionBar.reset()
    ...
    protected void initView() {
        ...
        //优惠券
        rv_youhuiquan = findViewByID_My(R.id.rv_youhuiquan);
        rv_youhuiquan.setLayoutManager(new LinearLayoutManager(this));
    }
    ...
    //优惠券
    private void RequestCoupon(Map<String, String> params) {
...
//                myToast(err);
            ...
            public void onResponse(CouponModel response) {
                hideProgress();
                list_youhuiquan = response.getList();
                if (list_youhuiquan.size() > 0) {
                    showContentPage();
                    mAdapter_youhuiquan = new CommonAdapter<CouponModel.ListBean>
                            (YiWanGongActivity.this, R.layout.item_coupon, list_youhuiquan) {
                        @Override
                    ...
                    rv_youhuiquan.setAdapter(mAdapter_youhuiquan);
                } else {
                    showEmptyPage();
                }
            }
...
//                showEmptyPage();
            ...
            public void onResponse(OrderDetailModel response) {
                ...
                /*if (model.getOrder_info().getGState() == 5)
                    titleView.setTitle("已完工");
                else titleView.setTitle("已付款");*/
               ...
               /* if (model.getOrder_info().getIsDelivery() == 1) {
                    ...
                    tv_songcheaddr.setVisibility(View.VISIBLE);
                    tv_songcheaddr.setText("送车地址："+model.getOrder_info().getSendAddress());
                } else {
                    tv_confirm.setText("提车");//联系客户改为 提车
                    tv_songcheaddr.setVisibility(View.GONE);
                }*/

                tv_fukuan.setVisibility(View.VISIBLE);
                if (model.getTechn_sedan_info().getIsPay() == 0) {
                    tv_fukuan.setText("支付");
                    tv_fukuan.setClickable(true);
                } else {
                    tv_fukuan.setText("已支付");
                ...
                mAdapter_service = new CommonAdapter<OrderDetailModel.OrderInfoBean.OrderServiceListBean>(
                        YiWanGongActivity.this, R.layout.item_service, model.getOrder_info().getOrder_service_list()) {
                    @Override
...
//                holder.setText(R.id.serviceallmoney, "¥" + bean.get);
                        ...
                        LinearLayoutManager llm1 = new LinearLayoutManager(YiWanGongActivity.this);
                        ...
                        CommonAdapter<OrderDetailModel.OrderInfoBean.OrderServiceListBean.OrderGoodsListBeanX> ca_s =
                                new CommonAdapter<OrderDetailModel.OrderInfoBean.OrderServiceListBean.OrderGoodsListBeanX>
                                        (YiWanGongActivity.this, R.layout.item_orderdetail_goods, bean.getOrder_goods_list()) {
                                    @Override
                                    protected void convert(ViewHolder holder, OrderDetailModel.OrderInfoBean.OrderServiceListBean.OrderGoodsListBeanX model1, int p) {
                                        ...
                                        Glide.with(YiWanGongActivity.this).load(URLs.IMGHOST + model1.getGoods_info().getGImg())
                                                .centerCrop()
...
//                                        String[] strArr = model1.getGoods_info().getImgStr().split("\\|\\|");
                                        ...
                                        CommonAdapter<String> ca = new CommonAdapter<String>
                                                (YiWanGongActivity.this, R.layout.item_img_80_80, list_img) {
                                            @Override
                                            protected void convert(ViewHolder holder, String model, int position) {
                                                ImageView iv = holder.getView(R.id.iv);
                                                Glide.with(YiWanGongActivity.this).load(model)
                                                        .centerCrop()
//                            .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                                                        .placeholder(R.mipmap.loading)//加载站位图
                                                        .error(R.mipmap.zanwutupian)//加载失败
                                        ...
                                        ca.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
                                            ...
                                            public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int i) {
                                                PhotoShowDialog photoShowDialog = new PhotoShowDialog(YiWanGongActivity.this, list_img, i);
                            ...
                            case 2:
                                ...
                                addgoods.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        CommonUtil.gotoActivityWithData(YiWanGongActivity.this, SelectGoodsActivity.class, bundle2, false);
                                    }
                                });
                                break;
                            case 3:
                ...
                mAdapter_other = new CommonAdapter<OrderDetailModel.OrderInfoBean.OrderGoodsListBean>
                        (YiWanGongActivity.this, R.layout.item_orderdetail_goods, model.getOrder_info().getOrder_goods_list()) {
                    @Override
...
//                            .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                ...
                mAdapter_jiance = new CommonAdapter<OrderDetailModel.TestingDetailsListBean>(
                        YiWanGongActivity.this, R.layout.item_orderdetail_jiance, model.getTesting_details_list()) {
                    @Override
...
//                            .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                        ...
                        tv_chageproject.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                CommonUtil.gotoActivityWithData(YiWanGongActivity.this, AddProjectActivity.class, bundle, false);
                            }
                        });
                        //删除商品
                        if (model.getOrder_info().getGState() >= 4) {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ll_feiyong:
                ...
                CommonUtil.gotoActivityWithData(YiWanGongActivity.this, CouponActivity.class, bundle4, false);
                break;
            case R.id.iv_message:
                ...
                CommonUtil.gotoActivityWithData(YiWanGongActivity.this, WebContentActivity.class, bundle, false);
                break;
            case R.id.iv_call:
                //拨打电话
...
//                               intent.setAction(Intent.ACTION_DIAL);//只调用拨号界面，不拨出电话
            ...
            case R.id.tv_addservice:
                ...
                CommonUtil.gotoActivityWithData(YiWanGongActivity.this, AddServiceActivity.class, bundle1, false);
                break;
            ...
            case R.id.tv_addproject:
                ...
                CommonUtil.gotoActivityWithData(YiWanGongActivity.this, AddProjectActivity.class, bundle3, false);
                break;
...
//                        break;
            ...
            case R.id.tv_fukuan:
                ...
                BaseDialog dialog1 = new BaseDialog(YiWanGongActivity.this);
                ...
                rv.setLayoutManager(new LinearLayoutManager(YiWanGongActivity.this));

                CommonAdapter<String> adapter = new CommonAdapter<String>
                        (YiWanGongActivity.this, R.layout.item_dialog_list, arrayList) {
                    @Override
                    protected void convert(ViewHolder holder, String model, int position) {
...
//                        dialog1.dismiss();
                ...
                dialog1.findViewById(R.id.tv_confirm).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        params.put("u_token", localUserInfo.getToken());
                        params.put("y_techn_sedan_id", y_techn_sedan_id);
                        params.put("pay_mode", arrayList.get(i1));
                        params.put("g_state", "7");//2为待施工 3为进行中 4待复检  5为待完工 6为已提车  7为付款
//                        RequestChageType(params, 7,true);
                        RequestChageType(params, 8,true);
                    }
                });
                break;
            ...
            case R.id.tv_fanhui:
                ...
                showToast("确认返回上一步吗？", "确认", "取消", new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        params.put("u_token", localUserInfo.getToken());
                        params.put("y_techn_sedan_id", y_techn_sedan_id);
                        params.put("g_state", "4");//2为待施工 3为进行中 4待复检  5为待完工 6为已提车  7为付款
                        RequestChageType(params, 4,false);
                    }
                }, new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
...
//                    finish();
                    if (isNext) {
                        ...
                        CommonUtil.gotoActivityWithData(YiWanGongActivity.this, YiFuKuanActivity.class, bundle, true);
                    } else {
//                        finish();
                        Bundle bundle = new Bundle();
                        bundle.putString("y_techn_sedan_id", y_techn_sedan_id);
                        CommonUtil.gotoActivityWithData(YiWanGongActivity.this, DaiFuJianActivity.class, bundle, true);
                    }
                }
    ...
    protected void updateView() {
        ...
        titleView.setRightBtn(R.mipmap.ic_scan_black, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CaptureActivity.launch(YiWanGongActivity.this, config);
            }
        });
    }
