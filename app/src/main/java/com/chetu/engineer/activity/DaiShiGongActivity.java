 ...
 * 待施工
 */
public class DaiShiGongActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daishigong);
        mImmersionBar.reset()
            ...
            public void onResponse(OrderDetailModel response) {
               ...
               /* if (model.getOrder_info() != null) {
                ...
                mAdapter_service = new CommonAdapter<OrderDetailModel.OrderInfoBean.OrderServiceListBean>(
                        DaiShiGongActivity.this, R.layout.item_service, model.getOrder_info().getOrder_service_list()) {
                    @Override
...
//                holder.setText(R.id.serviceallmoney, "¥" + bean.get);
                        ...
                        LinearLayoutManager llm1 = new LinearLayoutManager(DaiShiGongActivity.this);
                        ...
                        CommonAdapter<OrderDetailModel.OrderInfoBean.OrderServiceListBean.OrderGoodsListBeanX> ca_s =
                                new CommonAdapter<OrderDetailModel.OrderInfoBean.OrderServiceListBean.OrderGoodsListBeanX>
                                        (DaiShiGongActivity.this, R.layout.item_orderdetail_goods, bean.getOrder_goods_list()) {
                                    @Override
                                    protected void convert(ViewHolder holder, OrderDetailModel.OrderInfoBean.OrderServiceListBean.OrderGoodsListBeanX model1, int p) {
                                        ...
                                        Glide.with(DaiShiGongActivity.this).load(URLs.IMGHOST + model1.getGoods_info().getGImg())
                                                .centerCrop()
...
//                                        String[] strArr = model1.getGoods_info().getImgStr().split("\\|\\|");
                                        ...
                                        CommonAdapter<String> ca = new CommonAdapter<String>
                                                (DaiShiGongActivity.this, R.layout.item_img_80_80, list_img) {
                                            @Override
                                            protected void convert(ViewHolder holder, String model, int position) {
                                                ImageView iv = holder.getView(R.id.iv);
                                                Glide.with(DaiShiGongActivity.this).load(model)
                                                        .centerCrop()
//                            .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                                                        .placeholder(R.mipmap.loading)//加载站位图
                                                        .error(R.mipmap.zanwutupian)//加载失败
                                        ...
                                        ca.setOnItemClickListener(new OnItemClickListener() {
                                            ...
                                            public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int i) {
                                                PhotoShowDialog photoShowDialog = new PhotoShowDialog(DaiShiGongActivity.this, list_img, i);
                            ...
                            case 2:
                                ...
                                addgoods.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        CommonUtil.gotoActivityWithData(DaiShiGongActivity.this, SelectGoodsActivity.class, bundle2, false);
                                    }
                                });
                                break;
                            case 3:
                ...
                mAdapter_other = new CommonAdapter<OrderDetailModel.OrderInfoBean.OrderGoodsListBean>
                        (DaiShiGongActivity.this, R.layout.item_orderdetail_goods, model.getOrder_info().getOrder_goods_list()) {
                    @Override
...
//                            .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                ...
                mAdapter_jiance = new CommonAdapter<OrderDetailModel.TestingDetailsListBean>(
                        DaiShiGongActivity.this, R.layout.item_orderdetail_jiance, model.getTesting_details_list()) {
                    @Override
...
//                            .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                        ...
                        tv_chageproject.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                CommonUtil.gotoActivityWithData(DaiShiGongActivity.this, AddProjectActivity.class, bundle, false);
                            }
                        });
                        //删除商品
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ll_feiyong:
                ...
                CommonUtil.gotoActivityWithData(DaiShiGongActivity.this, CouponActivity.class, bundle4, false);
                break;
            case R.id.iv_message:
                ...
                CommonUtil.gotoActivityWithData(DaiShiGongActivity.this, WebContentActivity.class, bundle, false);
                break;
            case R.id.iv_call:
                //拨打电话
...
//                               intent.setAction(Intent.ACTION_DIAL);//只调用拨号界面，不拨出电话
            ...
            case R.id.tv_addservice:
                ...
                CommonUtil.gotoActivityWithData(DaiShiGongActivity.this, AddServiceActivity.class, bundle1, false);
                break;
            ...
            case R.id.tv_addproject:
                ...
                CommonUtil.gotoActivityWithData(DaiShiGongActivity.this, AddProjectActivity.class, bundle3, false);
                break;
...
//                        break;
            ...
            case R.id.tv_fukuan:
                ...
                showToast("确认退车吗？", "确认", "取消", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        dialog.dismiss();
                        Map<String, String> params = new HashMap<>();
                        params.put("u_token", localUserInfo.getToken());
                        params.put("y_techn_sedan_id", y_techn_sedan_id);
                        params.put("g_state", "1");//2为待施工 3为进行中 4待复检  5为待完工 6为已提车  7为付款
...
//                myToast("修改订单状态成功");
                if (type == 3) {
                    ...
                    CommonUtil.gotoActivityWithData(DaiShiGongActivity.this, JinXingZhongActivity.class, bundle, true);
                } else {
//                    finish();
                    Bundle bundle = new Bundle();
                    bundle.putString("y_techn_sedan_id", y_techn_sedan_id);
                    CommonUtil.gotoActivityWithData(DaiShiGongActivity.this, DaiFenPeiActivity.class, bundle, true);
                }
    ...
    protected void updateView() {
        ...
        titleView.setRightBtn(R.mipmap.ic_scan_black, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CaptureActivity.launch(DaiShiGongActivity.this, config);
            }
        });
    }
