 ...
 */
public class DianPuChuZhuDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dianpuchuzhudetail);
    }
    ...
    protected void initView() {
        ...
        LinearLayoutManager llm1 = new LinearLayoutManager(DianPuChuZhuDetailActivity.this);
    ...
    protected void initData() {
        model = (Fragment3Model.ListBean) getIntent().getSerializableExtra("DianPuChuZhuDetail");
        Glide.with(this)
...
//                                        .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
        ...
        tv_title.setText("标题：" + model.getLease_info().getV_title());
        tv_type.setText("联系人：" + model.getLease_info().getContacts());
        tv_addr.setText("联系方式：" + model.getLease_info().getContact_infor());
        tv_starttime.setText("费用：" + model.getLease_info().getV_cost());
        ...
        if (model.getLease_info().getImgArr() != null && model.getLease_info().getImgArr().size() > 0) {
            ...
            CommonAdapter<String> mAdapter_tupian = new CommonAdapter<String>
                    (DianPuChuZhuDetailActivity.this, R.layout.item_img_110_110, images) {
                @Override
                protected void convert(ViewHolder holder, String model, int position) {
                    ImageView iv = holder.getView(R.id.iv);
                    Glide.with(DianPuChuZhuDetailActivity.this)
                            .load(model)
                            .centerCrop()
                            .placeholder(R.mipmap.loading)//加载站位图
                            .error(R.mipmap.zanwutupian)//加载失败
            ...
            mAdapter_tupian.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
                ...
                public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int i) {
                    ...
                    PhotoShowDialog photoShowDialog = new PhotoShowDialog(DianPuChuZhuDetailActivity.this, images, i);
