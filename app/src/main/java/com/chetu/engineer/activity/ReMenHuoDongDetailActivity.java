 ...
 */
public class ReMenHuoDongDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remenhuodongdetail);
    }
    ...
    protected void initView() {
        ...
        LinearLayoutManager llm1 = new LinearLayoutManager(ReMenHuoDongDetailActivity.this);
    ...
    protected void initData() {
        model = (Fragment3Model.ListBean) getIntent().getSerializableExtra("ReMenHuoDongDetail");
        Glide.with(this)
...
//                                        .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
        ...
        tv_title.setText("标题：" + model.getV_title());
        tv_type.setText("类型：" + model.getActivity_info().getV_type());
        ...
        if (model.getActivity_info().getImgArr() != null && model.getActivity_info().getImgArr().size() > 0) {
            ...
            CommonAdapter<String> mAdapter_tupian = new CommonAdapter<String>
                    (ReMenHuoDongDetailActivity.this, R.layout.item_img_110_110, images) {
                @Override
                protected void convert(ViewHolder holder, String model, int position) {
                    ImageView iv = holder.getView(R.id.iv);
                    Glide.with(ReMenHuoDongDetailActivity.this)
                            .load(model)
                            .centerCrop()
                            .placeholder(R.mipmap.loading)//加载站位图
                            .error(R.mipmap.zanwutupian)//加载失败
            ...
            mAdapter_tupian.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
                ...
                public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int i) {
                    ...
                    PhotoShowDialog photoShowDialog = new PhotoShowDialog(ReMenHuoDongDetailActivity.this, images, i);
