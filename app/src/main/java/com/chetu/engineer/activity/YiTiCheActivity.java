 ...
 * 已提车
 */
public class YiTiCheActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yitiche);
        mImmersionBar.reset()
...
//                tv_yujitime.setText(model.getTechn_sedan_info().getEstimateTime().trim());//保养时间

                /**
                 * 服务列表
                 */
                mAdapter_service = new CommonAdapter<OrderDetailModel.OrderInfoBean.OrderServiceListBean>(
                        YiTiCheActivity.this, R.layout.item_service, model.getOrder_info().getOrder_service_list()) {
                    @Override
...
//                holder.setText(R.id.serviceallmoney, "¥" + bean.get);
                        ...
                        LinearLayoutManager llm1 = new LinearLayoutManager(YiTiCheActivity.this);
                        ...
                        CommonAdapter<OrderDetailModel.OrderInfoBean.OrderServiceListBean.OrderGoodsListBeanX> ca_s =
                                new CommonAdapter<OrderDetailModel.OrderInfoBean.OrderServiceListBean.OrderGoodsListBeanX>
                                        (YiTiCheActivity.this, R.layout.item_orderdetail_goods, bean.getOrder_goods_list()) {
                                    @Override
                                    protected void convert(ViewHolder holder, OrderDetailModel.OrderInfoBean.OrderServiceListBean.OrderGoodsListBeanX model1, int p) {
                                        ...
                                        Glide.with(YiTiCheActivity.this).load(URLs.IMGHOST + model1.getGoods_info().getGImg())
                                                .centerCrop()
...
//                                        String[] strArr = model1.getGoods_info().getImgStr().split("\\|\\|");
                                        ...
                                        CommonAdapter<String> ca = new CommonAdapter<String>
                                                (YiTiCheActivity.this, R.layout.item_img_80_80, list_img) {
                                            @Override
                                            protected void convert(ViewHolder holder, String model, int position) {
                                                ImageView iv = holder.getView(R.id.iv);
                                                Glide.with(YiTiCheActivity.this).load(model)
                                                        .centerCrop()
//                            .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                                                        .placeholder(R.mipmap.loading)//加载站位图
                                                        .error(R.mipmap.zanwutupian)//加载失败
                                        ...
                                        ca.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
                                            ...
                                            public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int i) {
                                                PhotoShowDialog photoShowDialog = new PhotoShowDialog(YiTiCheActivity.this, list_img, i);
                            ...
                            case 2:
                                ...
                                addgoods.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        CommonUtil.gotoActivityWithData(YiTiCheActivity.this, SelectGoodsActivity.class, bundle2, false);
                                    }
                                });
                                break;
                            case 3:
                ...
                mAdapter_other = new CommonAdapter<OrderDetailModel.OrderInfoBean.OrderGoodsListBean>
                        (YiTiCheActivity.this, R.layout.item_orderdetail_goods, model.getOrder_info().getOrder_goods_list()) {
                    @Override
...
//                            .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                ...
                mAdapter_jiance = new CommonAdapter<OrderDetailModel.TestingDetailsListBean>(
                        YiTiCheActivity.this, R.layout.item_orderdetail_jiance, model.getTesting_details_list()) {
                    @Override
...
//                            .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                        ...
                        tv_chageproject.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                CommonUtil.gotoActivityWithData(YiTiCheActivity.this, AddProjectActivity.class, bundle, false);
                            }
                        });
                        //删除商品
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ll_feiyong:
                ...
                CommonUtil.gotoActivityWithData(YiTiCheActivity.this, CouponActivity.class, bundle4, false);
                break;
            case R.id.iv_message:
                ...
                CommonUtil.gotoActivityWithData(YiTiCheActivity.this, WebContentActivity.class, bundle, false);
                break;
            case R.id.iv_call:
                //拨打电话
...
//                               intent.setAction(Intent.ACTION_DIAL);//只调用拨号界面，不拨出电话
            ...
            case R.id.tv_addservice:
                ...
                CommonUtil.gotoActivityWithData(YiTiCheActivity.this, AddServiceActivity.class, bundle1, false);
                break;
            ...
            case R.id.tv_addproject:
                ...
                CommonUtil.gotoActivityWithData(YiTiCheActivity.this, AddProjectActivity.class, bundle3, false);
                break;
...
//                        break;
            ...
            case R.id.tv_yujitime:
                //预计完成时间
//                setDate1("请选择下次保养时间", tv_yujitime, tv_yujitime.getText().toString().trim());
                List<String> arrayList = new ArrayList<>();
                for (int i = 0; i < 12; i++) {
                    arrayList.add((i + 1) + "");
                }

                BaseDialog dialog1 = new BaseDialog(YiTiCheActivity.this);
...
//                        dialog1.dismiss();
                ...
                dialog1.findViewById(R.id.tv_confirm).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        tv_yujitime.setText(arrayList.get(i1)+"个月后");
                        dialog1.dismiss();
                        Map<String, String> params = new HashMap<>();
                        params.put("u_token", localUserInfo.getToken());
                        params.put("y_techn_sedan_id", y_techn_sedan_id);
                        params.put("v_time", arrayList.get(i1));
...
//                myToast("修改订单状态成功");
    ...
    protected void updateView() {
        ...
        /*titleView.setRightBtn(R.mipmap.ic_scan_black, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CaptureActivity.launch(YiTiCheActivity.this, config);
            }
        });*/
    }
    ...
    private void RequestYuJiTime(Map<String, String> params) {
        OkhttpUtil.okHttpPost(URLs.BaoYangTime, params, headerMap, new CallBackUtil() {
            @Override
            public Object onParseResponse(Call call, Response response) {
                return null;
            }
...
//        calendar.add(Calendar.YEAR, 100);
        ...
        pvTime1 = new TimePickerBuilder(YiTiCheActivity.this, new OnTimeSelectListener() {
            @Override
