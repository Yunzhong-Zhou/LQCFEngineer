 ...
 */
public class GongJuZhuLinDetailActivity1 extends BaseActivity {
    //    ReMenHuoDongModel.ListBean model;
    Fragment1Model.ToolLeasingBean model;
    ImageView iv;
    ...
    protected void initView() {
        ...
        LinearLayoutManager llm1 = new LinearLayoutManager(GongJuZhuLinDetailActivity1.this);
    ...
    protected void initData() {
        model = (Fragment1Model.ToolLeasingBean) getIntent().getSerializableExtra("GongJuZhuLinDetail");
        Glide.with(this)
...
//        tv_content.setText("活动内容：" + model.getActivity_info().getV_content());
        ...
        if (model.getTool_info().getImgArr() != null && model.getTool_info().getImgArr().size() > 0) {
            ...
            CommonAdapter<String> mAdapter_tupian = new CommonAdapter<String>
                    (GongJuZhuLinDetailActivity1.this, R.layout.item_img_110_110, images) {
                @Override
                protected void convert(ViewHolder holder, String model, int position) {
                    ImageView iv = holder.getView(R.id.iv);
                    Glide.with(GongJuZhuLinDetailActivity1.this)
                            .load(model)
                            .centerCrop()
                            .placeholder(R.mipmap.loading)//加载站位图
                            .error(R.mipmap.zanwutupian)//加载失败
            ...
            mAdapter_tupian.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
                ...
                public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int i) {
                    ...
                    PhotoShowDialog photoShowDialog = new PhotoShowDialog(GongJuZhuLinDetailActivity1.this, images, i);
