...
public class ChePaiScannerActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chepaiscanner);
    }
    ...
    protected void initView() {
        scannerView = findViewByID_My(R.id.sv);
        /*tvResult = findViewByID_My(R.id.tv_result);
        scDirection = findViewByID_My(R.id.sc_direction);
        scZXing = findViewByID_My(R.id.sc_zxing);
        scZBar = findViewByID_My(R.id.sc_zbar);
        scBankCard = findViewByID_My(R.id.sc_bank);
        scIdCard = findViewByID_My(R.id.sc_id_card);
        scLicensePlate = findViewByID_My(R.id.sc_license_plate);
        scIdCard2 = findViewByID_My(R.id.sc_id_card2);
        scDrivingLicense = findViewByID_My(R.id.sc_driving_license);*/
...
//        scannerView.setViewFinder(new ViewFinder2());
        ...
        scannerView.setEnableLicensePlate(true);//车牌识别
...
//                tvResult.setText("识别结果：\n" + result.toString());
               ...
               /* Bundle bundle = new Bundle();
                bundle.putString("license_number", result.data);
                CommonUtil.gotoActivityWithData(ChePaiScannerActivity.this, AddJieCheActivity.class, bundle, true);*/

                Intent resultIntent = new Intent();
                Bundle bundle = new Bundle();
                bundle.putString("license_number", result.data);
                resultIntent.putExtras(bundle);
                ChePaiScannerActivity.this.setResult(RESULT_OK, resultIntent);
                finish();
