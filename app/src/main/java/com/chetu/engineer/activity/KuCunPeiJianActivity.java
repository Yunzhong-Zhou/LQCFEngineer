 ...
 * 库存配件
 */
public class KuCunPeiJianActivity extends BaseActivity {
    int page = 0;
    ...
    protected void initView() {
        ...
        springView.setListener(new SpringView.OnFreshListener() {
            ...
            public void onRefresh() {
                ...
                params.put("i_classify", "4");//1为招聘 2为案例 3为店铺出租 4为二手配件 5为工具租赁 6为机友求助 7为技术交流 8为活动
            ...
            public void onResponse(Fragment3Model response) {
                ...
                if (list.size() > 0) {
                    ...
                    mAdapter = new CommonAdapter<Fragment3Model.ListBean>
                            (KuCunPeiJianActivity.this, R.layout.item_kucunpeijian, list) {
                        @Override
...
//                            holder.setText(R.id.tv_addr, model.getParts_info().get);
                            ...
                            Glide.with(KuCunPeiJianActivity.this)
...
//                                        .apply(RequestOptions.bitmapTransform(new RoundedCorners(10)))
                           ...
                           /* //显示时间
                            ...
                            if (model.getParts_info().getImgArr() != null && model.getParts_info().getImgArr().size() > 0) {
                                ...
                                LinearLayoutManager llm1 = new LinearLayoutManager(KuCunPeiJianActivity.this);
                                ...
                                CommonAdapter<String> mAdapter_tupian = new CommonAdapter<String>
                                        (KuCunPeiJianActivity.this, R.layout.item_img_110_110, images) {
                                    @Override
                                ...
                                mAdapter_tupian.setOnItemClickListener(new OnItemClickListener() {
                                    ...
                                    public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int i) {
                                        ...
                                        PhotoShowDialog photoShowDialog = new PhotoShowDialog(KuCunPeiJianActivity.this, images, i);
                    ...
                    mAdapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
                        ...
                        public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int i) {
                            ...
                            CommonUtil.gotoActivityWithData(KuCunPeiJianActivity.this, KuCunPeiJianDetailActivity.class, bundle, false);
                        }
    ...
    protected void updateView() {
        ...
        titleView.showRightTextview("发布", R.color.blue, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CommonUtil.gotoActivity(KuCunPeiJianActivity.this, AddKuCunPeiJianActivity.class, false);
            }
        });
    }
}
